...
namespace InventoryManagement.Migrations
{
    ...
    [Migration("20251115151028_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagement.Models.ReturnDetail", b =>
                {
            ...
            modelBuilder.Entity("InventoryManagement.Models.ReturnOrder", b =>
                {
                    b.Property<int>("ReturnID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReturnOrders", t =>
                        {
                            t.HasCheckConstraint("CK_ReturnOrders_Status", "[Status] IN ('Submitted','Confirmed','Cancelled')");
                        });
                });
            ...
            modelBuilder.Entity("InventoryManagement.Models.ReturnDetail", b =>
                {
                    ...
                    b.HasOne("InventoryManagement.Models.ReturnOrder", "ReturnOrder")
                        .WithMany("Details")
